...
into llm-mem ingest calls. Handles reconnection on server restart.
"""
...
class OpenCodeAdapter:
    """Listens to OpenCode SSE events and ingests them into llm-mem."""
    ...
    def process_event(self, event: dict[str, Any]) -> EventInput | None:
        """Translate an OpenCode SSE event into an llm-mem EventInput.
